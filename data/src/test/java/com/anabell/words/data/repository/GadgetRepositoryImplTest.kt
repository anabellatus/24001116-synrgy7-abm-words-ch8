...
class GadgetRepositoryImplTest {

    private val remoteDataSource = mock<GadgetRemoteDataSource>()
    private val localDataSource = mock<GadgetLocalDataSource>()

    private val repository = GadgetRepositoryImpl(
        remoteDataSource = remoteDataSource,
        localDataSource = localDataSource
    )

    @Test
    fun fetchGadgetData()  = runTest{
        ...
        //when
        whenever(remoteDataSource.fetchGadgetData()).thenReturn(gadgetList)
        val actual = repository.fetchGadgetData()
